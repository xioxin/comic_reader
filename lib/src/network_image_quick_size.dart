...
class NetworkImageQuickSize extends ImageProvider<NetworkImageQuickSize> {
  ...
  const NetworkImageQuickSize(this.url, {
    this.scale = 1.0,
    this.headers,
    this.onImageSize,
  })
  ...
  ImageStreamCompleter load(NetworkImageQuickSize key, DecoderCallback decode) {
    ...
    return MultiFrameImageStreamCompleter(
      codec: _loadAsync(key as NetworkImageQuickSize, chunkEvents, decode),
  ...
  Future<ui.Codec> _loadAsync(
    ...
    try {
      ...
      final Uint8List bytes = await consolidateHttpClientResponseBytesAndGetImageSize(
        response,
  ...
  @override
  String toString() => '${objectRuntimeType(this, 'NetworkImageQuickSize')}("$url", scale: $scale)';
}
